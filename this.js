...
//     prettyBind
// }
// obj.prettyBind(); // 결과: { name: 'seungit!' }
...
// carName(); // 결과: undefined
// carName.apply(bmw); // 결과: BMW
// carName.apply(audi); // 결과: AUDI

// showCar.apply(bmw, [4, "O"]);   // 매개변수를 배열로 받는다.
// showCar.apply(audi, [4, "X"]);  // 매개변수를 배열로 받는다.
// console.log(bmw); // 결과: { name: 'BMW', wheels: 4, navigation: 'O' }
// console.log(audi); // 결과: { name: 'AUDI', wheels: 4, navigation: 'X' }